...
export default function Column({
  ...
  return (
    <section
      ...
      ref={setNodeRef} //  KUN droppable-ref her
      ...
      >
        ...
        {menuOpen && (
          <>
            ...
            <div
              role="menu"
              className="absolute right-3 top-10 z-50 w-44 rounded-xl bg-zinc-900 text-sm ring-1 ring-white/10 shadow-lg overflow-hidden"
              onPointerDown={(e) => e.stopPropagation()}
            >
              <button
                role="menuitem"
